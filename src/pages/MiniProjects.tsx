          ...
          <div className="max-w-3xl space-y-4 text-left">
            ...
            <FadeIn direction="up" delay={0.15}>
              <p className="text-lg text-text-muted leading-relaxed">
                Horizontal repository streams featuring UI layout labs, specialized Jetpack Compose animations, and canvas-intensive micro-visualizers.
              </p>
            </FadeIn>
          </div>
                ...
                <div className="flex p-1.5 rounded-xl bg-surface border border-white/5 shadow-md gap-1 min-w-max">
                  {(['all', 'web', 'android', 'ios', 'desktop', 'backend'] as const).map(tab => (
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-lg transition-all duration-300 flex items-center gap-1.5 ${
                        filter === tab
